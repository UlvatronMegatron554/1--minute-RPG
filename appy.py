...
st.markdown(f"""
    ...
    @keyframes titan-pulse {{
        0% {{ box-shadow: 0 0 20px {active_color}, inset 0 0 10px {active_color}; border-color: {active_color}; }}
        50% {{ box-shadow: 0 0 85px {active_color}, inset 0 0 45px {active_color}; border-color: #FFFFFF; }}
        100% {{ box-shadow: 0 0 20px {active_color}, inset 0 0 10px {active_color}; border-color: {active_color}; }}
    }}
    div.stButton > button {{
